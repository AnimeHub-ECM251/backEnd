...
-- Criar animes
insert into AnimeHubDB.Anime (title, id, image, synopsis, episodes, launchDate, studio, publicRating, websiteRating) values ('Naruto', 1, 'https://cdn.myanimelist.net/images/anime/13/17405.jpg', 'Naruto é uma série de mangá escrita e ilustrada por Masashi Kishimoto', 220, '2002-10-03', 'Pierrot', 2, 10);
...
insert into AnimeHubDB.Anime (title, id, image, synopsis, episodes, launchDate, studio, publicRating, websiteRating) values ('Dragon Ball Z', 8, 'https://cdn.myanimelist.net/images/anime/1607/117271.jpg', 'O irmão de Son Goku (protagonista da série Dragon Ball) aparece na Terra e lhe informa que sua família pertence a outro planeta.', 291, '1989-04-26', 'Toei Animation', -1, 10);
...
insert into AnimeHubDB.Anime (title, id, image, synopsis, episodes, launchDate, studio, publicRating, websiteRating) values ('Mirai Nikki', 14, 'https://cdn.myanimelist.net/images/anime/13/33465.jpg', 'Mirai Nikki é um mangá shōnen escrito e ilustrado por Sakae Esuno', 26, '2011-10-10', 'Asread', -1, 9);
insert into AnimeHubDB.Anime (title, id, image, synopsis, episodes, launchDate, studio, publicRating, websiteRating) values ('Hunter x Hunter', 15, 'https://cdn.myanimelist.net/images/anime/11/33657.jpg', 'Hunter × Hunter é uma série de mangá escrita e ilustrada por Yoshihiro Togashi.', 148, '1999-10-16', 'Nippon Animation', -1, 10);
